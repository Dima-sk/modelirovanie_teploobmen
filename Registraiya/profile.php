                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Укажите количество</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="./create/add_tools.php" method="post">
                                <input type='hidden' id='uiidd' name='id'/>
                                <input type="hidden" class="userId" name='id' id="uidd" value="<? echo NULL ?>">
                                <input type='number' id='quantity' name='quantity'/>
                                    <input class="btn btn-primary" name="submit" style="color: #ffffff!important;"type='submit' value='Подтвердить'>
                                </div>
                            </form>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" style="color: #ffffff!important;" data-bs-dismiss="modal">Отмена</button>
                            </div>
                        </div>
                    </div>
                </div> -->
<main role="main">
        <article>
            ...
            <section>
            <form action="create/add_calculations.php" method="post" class="form" >
              <h1 class="h3 mb-3 fw-normal">Введите исходные данные</h1>

                  <div class="form-floating">
                  <input type="float" class="form-control"  name="name_calculations" placeholder="0">
                  <label for="floatingInput">Название</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="layer_height" placeholder="0">
                  <label for="floatingInput">Высота слоя, м</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="initial_material_temperature" placeholder="0">
                  <label for="floatingInput">Начальная температура материала, °С</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="initial_gas_temperature"  placeholder="0">
                  <label for="floatingInput">Начальная температура газа, °С</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="gas_speed"  placeholder="0">
                  <label for="floatingInput">Скорость газа на свободное сечение шахты, м/с</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="average_heat_capacity_of_gas"  placeholder="0">
                  <label for="floatingInput">Средняя теплоемкость газа,кДж/(м3 • К).</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="material_consumption"  placeholder="0">
                  <label for="floatingInput">Расход материалов кг/с</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="heat_capacity_of_materials"  placeholder="0">
                  <label for="floatingInput">Теплоемкость материалов, кДж/(кг • К)</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="volumetric_heat_transfer_coefficient"  placeholder="0">
                  <label for="floatingInput">Объемный коэффициент теплоотдачи,Вт/(м3 • К).</label>
                  </div>
                  <div class="form-floating">
                  <input type="float" class="form-control decimal-input" id="number" name="device_diameter"  placeholder="0">
                  <label for="floatingInput">Диаметр аппарата, м</label>
                  </div>
              <button class="w-100 btn btn-lg btn-primary"style="color: #ffffff!important;" type="submit" name="sublogin">Записать исходные данные</button>
            </form>
