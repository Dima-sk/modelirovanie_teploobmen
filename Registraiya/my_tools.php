...
<main role="main">
        <article>
            <header>
                <h1 class="header__title">Мои инструменты</h1>
            </header>
            <section>
               <?php
               $result=mysqli_query($connect, $sql);
            ...
            ?>
               <div class="wrap">
                <div class="block_content">
                    <h2 class="node-title"><?php  echo $row['name_tool'];?></h2>
                    <div class="info">
                    <p class="author"><?php echo "Количество ",$row['actual_quantity']," из ", $row['quantity']?></p>
                    <?php echo "<a class='btn btn-danger btn-sm'style='color: #ffffff!important;' 
                    href='./delete/delete_tools.php?id_tool=".$id_tool."'>"?>Вернуть</a>
